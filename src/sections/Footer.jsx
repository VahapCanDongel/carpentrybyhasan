    ...
    return (
        <div className="flex justify-between items-center w-full p-6">
            ...
            <div className="flex flex-col justify-center items-center text-[13px]">
                ...
                <a href="https://www.vahapcandongel.co.uk/" target="_blank" className="font-semibold">vahapcandongel.co.uk</a>
            </div>
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <div className="text-[18px]">carpenterbyhasan@gmail.com</div>
            </div>
